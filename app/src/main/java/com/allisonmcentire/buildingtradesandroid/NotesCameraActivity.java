...
public class NotesCameraActivity extends Activity implements PermissionRequest.Response {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        childRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uri) {
                                ...
                                Intent notesIntent = new Intent(NotesCameraActivity.this, Notes2Activity.class);
                                notesIntent.putExtra("notesImageURL", imageURL);
                        ...
                        Toast.makeText(NotesCameraActivity.this, "Upload successful", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(NotesCameraActivity.this, Notes2Activity.class));
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {

                        Toast.makeText(NotesCameraActivity.this, "Upload Failed -> " + e, Toast.LENGTH_SHORT).show();
                    }
                });
            }
