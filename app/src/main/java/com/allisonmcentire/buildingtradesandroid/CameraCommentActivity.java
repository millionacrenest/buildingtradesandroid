...
public class CameraCommentActivity extends Activity implements PermissionRequest.Response {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sitekey = intent.getStringExtra(EXTRA_POST_KEY);

        Toast.makeText(CameraCommentActivity.this, sitekey, Toast.LENGTH_SHORT).show();
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        childRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uri) {
                                String imageCommentURL = String.valueOf(uri);
                                Intent intent = new Intent(CameraCommentActivity.this, MapDetailActivity.class);
                                intent.putExtra("Image Comment URL", imageCommentURL);
                        ...
                        Toast.makeText(CameraCommentActivity.this, "Upload successful", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(CameraCommentActivity.this, Map2Activity.class));
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {

                        Toast.makeText(CameraCommentActivity.this, "Upload Failed -> " + e, Toast.LENGTH_SHORT).show();
                    }
                });
            }
