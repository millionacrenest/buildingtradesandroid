...
public class CameraNotesActivity extends Activity implements PermissionRequest.Response {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(CameraNotesActivity.this, sitekey, Toast.LENGTH_SHORT).show();
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        childRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uri) {
                                String imageNotesURL = String.valueOf(uri);
                                Intent intent = new Intent(CameraNotesActivity.this, Notes2Activity.class);
                                intent.putExtra("Image Comment URL", imageNotesURL);
                        ...
                        Toast.makeText(CameraNotesActivity.this, "Upload successful", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(CameraNotesActivity.this, Map2Activity.class));
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {

                        Toast.makeText(CameraNotesActivity.this, "Upload Failed -> " + e, Toast.LENGTH_SHORT).show();
                    }
                });
            }
